                    ...
                    <div class="p-4 shadow" style="border-radius:1rem;">
                        ...
                        <div class="form-group mb-">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="col"><input type="email" name="admin_reset_identifiant[email]" class="form-control rounded-pill shadow-none" id="inputAddress2" placeholder="" value="<?= $router->getValPost(['admin_reset_identifiant', 'email']) ?>"></div>
                            </div>
