        ...
        <div class="d-flex justify-content-center w-100">
            <div class="col-12 col-sm-8 col-md-6">
                ...
                <form method="post" class="w-100 my-3">
                    <p class="text-right pr-2"><a href="creer-compte.php" class="text-ederalab">Créer un compte Dentiste</a></p>
                    <div class="p-4 shadow" style="border-radius:1rem;">
                        ...
                        <div class="form-group mb-">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="col"><input type="email" name="dentiste_signin[email]" class="form-control rounded-pill shadow-none" id="inputAddress2" placeholder="" value="<?= $router->getValPost(['dentiste_signin', 'email']) ?>"></div>
                            </div>
                            <?= $router->errorHTML2('email'); ?>
                        </div>
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                <div class="col-4 p-0"><label for="inputAddress2" class="" style="color:#2c4c64;">Mot de passe</label></div>
                                <div class="col">
                                    <div class="input-flex-group" id="login_password">
                                        <input type="password" name="dentiste_signin[password]" class="form-control rounded-pill shadow-none" id="inputAddress2" placeholder="">
                    ...
                    <p class="text-right pr-2 mt-2"><a href="reinitialisation-mot-de-passe.php" class="text-ederalab">Mot de passe oublié ?</a></p>

                    <div class="form-group text-center mt-5">
                        <button class="btn p-3 btn-ederalab" style="min-width:190px;border-radius:10px;">Connexion</button>
                    </div>
                    <input type="hidden" name="csrf" value="<?= password_hash('dentiste-signin', 1); ?>">
                </form>
            </div>
        </div>
    </div>
