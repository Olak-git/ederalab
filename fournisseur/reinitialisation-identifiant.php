                ...
                <form method="post" class="w-100 my-3">
                    <div class="p-4 shadow" style="border-radius:1rem;">
                        <div class="d-flex flex-wrap justify-content-between">
                            ...
                            <h6>Réinitialisation de votre identifiant</h6>
                        </div>
                        <div class="form-group mb-">
                            <div class="d-flex align-items-center">
                                <div class="col-4 p-0"><label for="inputAddress2" class="" style="color:#2c4c64;">Adresse e-mail</label></div>
                                <div class="col"><input type="email" name="collaborateur_reset_identifiant[email]" class="form-control rounded-pill shadow-none" id="inputAddress2" placeholder="" value="<?= $router->getValPost(['collaborateur_reset_identifiant', 'email']) ?>"></div>
                            </div>
                    ...
                    <input type="hidden" name="csrf" value="<?= password_hash('reset-identifiant', 1); ?>">
                </form>
            </div>
        </div>
    </div>
