                ...
                <form method="post" class="w-100">
                    ...
                    <div class="py-3 px-5 shadow" style="border-radius:1rem;">
                        ...
                        <div class="form-group mb-5 px-4">
                            <label for="inputAddress2" class="text-center d-block mb-4" style="color:#2c4c64;font-size:1.25rem;">Identifiant du Fournisseur</label>  
                            <div class="input-flex-group" id="login_password">
                                <input type="password" name="signin_transporteur[identifiant]" class="form-control form-control-lg form-style shadow-none text-center" id="inputAddress2" placeholder="" style="background:#f0ecec;">
                    ...
                    <input type="hidden" name="csrf" value="<?= password_hash('transporteur-signin', 1); ?>">
                </form>
            </div>
        </div>
    </div>
