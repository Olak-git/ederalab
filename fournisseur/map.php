...
?>
    ...
    <div class="menu-top">
        ...
        <?php /*<div class="mb-0 mr-4">
                <div class="input-group d-flex justify-content-between align-items-center border border-ederalab position-relative">
                    <input type="search" placeholder="Adresse" onkeyup="getSearchResult(this);" class="plou form-control form-control-sm px-2" />
            ...
            <span class="d-flex justify-content-between align-items-center mt- h-100">
                ...
                <a href="parametres.php" class="d-flex justify-content-center align-items-center text-ederalab h-100 hlink<?= isset($hlink) && $hlink == 2 ? ' active' : ''; ?>" style="width:50px;">
