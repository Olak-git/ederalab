        ...
        <div class="links">
            <nav class="h-100">
                <ul class="h-100 mb-0 pl-0">
                    ...
                    <li class="<?= isset($header_link) && $header_link == 2 ? 'active' : ''; ?>"><a href="map.php" class="flex-center header-link">Map</a></li>
