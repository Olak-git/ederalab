                ...
                <form method="post" action="" enctype="multipart/form-data" name="chat" onsubmit="sendMessage(this);" class="w-100 h-100">
                    <div class="form-group h-100 p-1 d-flex align-items-center">
                        <div class="w-100 d-flex flex-row justify-content-center align-items-center position-relative">
                            ...
                            <div class="w-100 d-flex border rounded-pill" style="overflow:hidden;background:#fff;">
                            ...
                            <input type="hidden" name="chat[exp]" value="<?= password_hash('transporteur', 1); ?>">
                            <input type="hidden" name="chat[dest]" value="<?= $router->getTransporteur()->getSlug(); ?>">
                            <input type="hidden" name="chat[compte_dest]" value="transporteur">
